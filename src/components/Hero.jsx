...
const Hero = () => {
  return (
    <div className='md:flex pt-2 md:px-17 gap-4'>
      <div className='md:w-1/2 rounded-2xl shadow-xl bg-blue-500 text-white flex flex-col justify-center items-center p-10'>
      ...
      <div className='md:w-1/2 relative overflow-hidden rounded-2xl shadow-xl'>
  <img
